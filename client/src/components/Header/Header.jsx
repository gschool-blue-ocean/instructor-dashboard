...
function Header() {
  ...
  return (
    <div>
      <div>
        <div className="flex justify-between h-10 px-2">
          {showSideBar && <App setSideBar={setSideBar} />}
          <div className="h-10 mr-2" onClick={handleSidebar}>
            <img
              src="https://dotcom-files.s3.us-west-2.amazonaws.com/galvanize_logo_full-color_light-background.png"
              alt="logo"
              className="h-10 pr-80"
            />
          </div>
          <div className="flex justify-between w-auto h-10 px-2">
